...
--
-- Host: localhost
-- Generation Time: Nov 28, 2014 at 10:36 AM
...
--
-- Table structure for table `tml_assets`
--

CREATE TABLE IF NOT EXISTS `tml_assets` (
...
--
-- Dumping data for table `tml_assets`
--

INSERT INTO `tml_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(56, 1, 107, 108, 1, 'com_timeline', 'timeline', '{}'),
(57, 18, 70, 71, 2, 'com_modules.module.87', 'Product Timeline', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}');

-- --------------------------------------------------------

--
-- Table structure for table `tml_associations`
--

CREATE TABLE IF NOT EXISTS `tml_associations` (
...
--
-- Table structure for table `tml_banners`
--

CREATE TABLE IF NOT EXISTS `tml_banners` (
...
--
-- Table structure for table `tml_banner_clients`
--

CREATE TABLE IF NOT EXISTS `tml_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `tml_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `tml_banner_tracks` (
...
--
-- Table structure for table `tml_categories`
--

CREATE TABLE IF NOT EXISTS `tml_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `tml_categories`
--

INSERT INTO `tml_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Table structure for table `tml_contact_details`
--

CREATE TABLE IF NOT EXISTS `tml_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `tml_content`
--

CREATE TABLE IF NOT EXISTS `tml_content` (
...
--
-- Table structure for table `tml_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `tml_contentitem_tag_map` (
...
--
-- Table structure for table `tml_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `tml_content_frontpage` (
...
--
-- Table structure for table `tml_content_rating`
--

CREATE TABLE IF NOT EXISTS `tml_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `tml_content_types`
--

CREATE TABLE IF NOT EXISTS `tml_content_types` (
...
--
-- Dumping data for table `tml_content_types`
--

INSERT INTO `tml_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `tml_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `tml_core_log_searches` (
...
--
-- Table structure for table `tml_extensions`
--

CREATE TABLE IF NOT EXISTS `tml_extensions` (
...
--
-- Dumping data for table `tml_extensions`
--

INSERT INTO `tml_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '{"mediaversion":"03e581aebababddb28e007e6baa7148a"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10003, 'RBSL Framework!', 'plugin', 'rbsl', 'system', 0, 1, 1, 0, '{"name":"RBSL Framework!","type":"plugin","creationDate":"July 2012","author":"Ready Bytes Software Labs Pvt. Ltd.","copyright":"Copyright (C) 2009 - 2012 Ready Bytes Softwrae Labs. All rights reserved.","authorEmail":"team@readybytes.in","authorUrl":"www.readybytes.in","version":"1.0.2","description":"RBSL Framework: Should be Enabled for JoomlaXi extensions","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', -9999, 0),
(10005, 'timeline', 'component', 'com_timeline', '', 1, 1, 0, 0, '{"name":"Timeline","type":"component","creationDate":"2014-02-18","author":"Dotsquares Technologies","copyright":"","authorEmail":"jitendra.kumar@dotsquares.com","authorUrl":"http:\\/\\/www.dotsquares.com","version":"1.0.0","description":"This Component helps you to manage Access Logs of Vouchers.","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10006, 'mod_timeline', 'module', 'mod_timeline', '', 0, 1, 0, 0, '{"name":"mod_timeline","type":"module","creationDate":"Oct. 2014","author":"Dotsquares Technologies","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"jitendra.kumar@dotsquares.com","authorUrl":"www.dotsquares.com","version":"1.0","description":"MOD_TIMELINE_XML_DESCRIPTION","group":""}', '{"item_count":"5"}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `tml_finder_filters`
--

CREATE TABLE IF NOT EXISTS `tml_finder_filters` (
...
--
-- Table structure for table `tml_finder_links`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links` (
...
--
-- Table structure for table `tml_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links_terms0` (
...
--
-- Table structure for table `tml_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `tml_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `tml_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `tml_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `tml_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `tml_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `tml_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `tml_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `tml_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `tml_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `tml_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `tml_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `tml_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `tml_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `tml_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `tml_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `tml_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `tml_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `tml_finder_taxonomy`
--

INSERT INTO `tml_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `tml_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `tml_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `tml_finder_terms`
--

CREATE TABLE IF NOT EXISTS `tml_finder_terms` (
...
--
-- Table structure for table `tml_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `tml_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `tml_finder_terms_common`
--

INSERT INTO `tml_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `tml_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `tml_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `tml_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `tml_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `tml_finder_types`
--

CREATE TABLE IF NOT EXISTS `tml_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `tml_languages`
--

CREATE TABLE IF NOT EXISTS `tml_languages` (
...
--
-- Dumping data for table `tml_languages`
--

INSERT INTO `tml_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `tml_menu`
--

CREATE TABLE IF NOT EXISTS `tml_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `tml_menu`
--

INSERT INTO `tml_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(103, 'main', 'COM_VALOGS_SUBMENU_DASHBOARD', 'com-valogs-submenu-dashboard', '', 'com-valogs-menu-name/com-valogs-submenu-dashboard', 'index.php?option=com_valogs&view=dashboard', 'component', 0, 102, 2, 0, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '', 50, 51, 0, '', 1),
(109, 'main', 'items', 'items', '', 'timeline/items', 'index.php?option=com_timeline&view=items', 'component', 0, 108, 2, 0, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '', 54, 55, 0, '', 1),
(114, 'main', 'Timeline', 'timeline', '', 'timeline', 'index.php?option=com_timeline', 'component', 0, 1, 1, 10005, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '', 57, 60, 0, '', 1),
(115, 'main', 'items', 'items', '', 'timeline/items', 'index.php?option=com_timeline&view=items', 'component', 0, 114, 2, 10005, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '', 58, 59, 0, '', 1);

-- --------------------------------------------------------

--
-- Table structure for table `tml_menu_types`
--

CREATE TABLE IF NOT EXISTS `tml_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `tml_menu_types`
--

INSERT INTO `tml_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `tml_messages`
--

CREATE TABLE IF NOT EXISTS `tml_messages` (
...
--
-- Table structure for table `tml_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `tml_messages_cfg` (
...
--
-- Table structure for table `tml_modules`
--

CREATE TABLE IF NOT EXISTS `tml_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `tml_modules`
--

INSERT INTO `tml_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(87, 57, 'Product Timeline', '', '', 1, 'position-3', 8, '2014-10-02 06:33:59', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_timeline', 1, 1, '{"item_count":"5","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `tml_modules_menu`
--

CREATE TABLE IF NOT EXISTS `tml_modules_menu` (
...
--
-- Dumping data for table `tml_modules_menu`
--

INSERT INTO `tml_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `tml_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `tml_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `tml_overrider`
--

CREATE TABLE IF NOT EXISTS `tml_overrider` (
...
--
-- Table structure for table `tml_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `tml_postinstall_messages` (
...
--
-- Dumping data for table `tml_postinstall_messages`
--

INSERT INTO `tml_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `tml_rb_ecommerce_country`
--

CREATE TABLE IF NOT EXISTS `tml_rb_ecommerce_country` (
...
--
-- Dumping data for table `tml_rb_ecommerce_country`
--

INSERT INTO `tml_rb_ecommerce_country` (`country_id`, `title`, `isocode2`, `isocode3`, `isocode3n`) VALUES
...
--
-- Table structure for table `tml_rb_ecommerce_currency`
--

CREATE TABLE IF NOT EXISTS `tml_rb_ecommerce_currency` (
...
--
-- Dumping data for table `tml_rb_ecommerce_currency`
--

INSERT INTO `tml_rb_ecommerce_currency` (`currency_id`, `title`, `published`, `params`, `symbol`) VALUES
...
--
-- Table structure for table `tml_rb_ecommerce_invoice`
--

CREATE TABLE IF NOT EXISTS `tml_rb_ecommerce_invoice` (
...
--
-- Table structure for table `tml_rb_ecommerce_modifier`
--

CREATE TABLE IF NOT EXISTS `tml_rb_ecommerce_modifier` (
...
--
-- Table structure for table `tml_rb_ecommerce_transaction`
--

CREATE TABLE IF NOT EXISTS `tml_rb_ecommerce_transaction` (
...
--
-- Table structure for table `tml_redirect_links`
--

CREATE TABLE IF NOT EXISTS `tml_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `tml_schemas`
--

CREATE TABLE IF NOT EXISTS `tml_schemas` (
...
--
-- Dumping data for table `tml_schemas`
--

INSERT INTO `tml_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.2.2-2014-01-23');

-- --------------------------------------------------------

--
-- Table structure for table `tml_session`
--

CREATE TABLE IF NOT EXISTS `tml_session` (
...
--
-- Dumping data for table `tml_session`
--

INSERT INTO `tml_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('e2uk98gcfr9vdh567vj37omcc3', 0, 1, '1415353597', '__default|a:8:{s:15:"session.counter";i:7;s:19:"session.timer.start";i:1415350113;s:18:"session.timer.last";i:1415352757;s:17:"session.timer.now";i:1415353597;s:22:"session.client.browser";s:76:"Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:32.0) Gecko/20100101 Firefox/32.0";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"252631a24b585f7e201aa7e14c06ea1b";}', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `tml_tags`
--

CREATE TABLE IF NOT EXISTS `tml_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `tml_tags`
--

INSERT INTO `tml_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `tml_template_styles`
--

CREATE TABLE IF NOT EXISTS `tml_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `tml_template_styles`
--

INSERT INTO `tml_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `tml_timeline_items`
--

CREATE TABLE IF NOT EXISTS `tml_timeline_items` (
...
--
-- Dumping data for table `tml_timeline_items`
--

INSERT INTO `tml_timeline_items` (`items_id`, `short_title`, `title`, `description`, `created_date`, `ordering`, `published`) VALUES
(1, '2001', 'Dummy', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>\r\n<p> </p>', '2014-08-27 05:37:40', 1, 1),
(2, '2003', 'dummy 2', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>', '2014-09-23 01:20:18', 2, 1),
(3, '2006', 'Dummy 3', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>', '2014-10-01 00:10:56', 3, 1),
(4, '2009', 'Dummy 4', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>', '2014-10-01 00:11:31', 4, 1),
(5, '2012', 'Dummy 5', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>', '2014-10-01 00:11:49', 5, 1),
(6, '2013', 'Dummy 6', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>', '2014-10-01 04:29:41', 6, 1),
(7, '2014', 'Dummy 7', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>', '2014-10-01 04:30:03', 7, 1),
(8, 'JAN', 'Dummy 8', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>', '2014-10-01 04:30:24', 8, 1),
(9, 'FAB', 'FAB', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>', '2014-10-01 04:31:01', 9, 1),
(10, 'MARCH', 'MARCH', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>', '2014-10-01 04:31:24', 10, 1),
(11, 'APRIL', 'APRIL', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>', '2014-10-01 04:31:41', 11, 1);

-- --------------------------------------------------------

--
-- Table structure for table `tml_timeline_timelines`
--

CREATE TABLE IF NOT EXISTS `tml_timeline_timelines` (
  `timelines_id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  ...
  `created_date` datetime NOT NULL,
  `modified_date` datetime NOT NULL,
  PRIMARY KEY (`timelines_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;

--
-- Dumping data for table `tml_timeline_timelines`
--

INSERT INTO `tml_timeline_timelines` (`timelines_id`, `title`, `associated_items`, `ordering`, `published`, `created_date`, `modified_date`) VALUES
(1, 'dummy', '1', 1, 1, '2014-09-26 09:27:40', '2014-09-26 10:06:05'),
(2, 'dummy 2', '1,2', 2, 1, '2014-09-26 09:33:13', '2014-09-26 09:33:13');

-- --------------------------------------------------------

--
-- Table structure for table `tml_ucm_base`
--

CREATE TABLE IF NOT EXISTS `tml_ucm_base` (
...
--
-- Table structure for table `tml_ucm_content`
--

CREATE TABLE IF NOT EXISTS `tml_ucm_content` (
...
--
-- Table structure for table `tml_ucm_history`
--

CREATE TABLE IF NOT EXISTS `tml_ucm_history` (
...
--
-- Table structure for table `tml_updates`
--

CREATE TABLE IF NOT EXISTS `tml_updates` (
...
--
-- Dumping data for table `tml_updates`
--

INSERT INTO `tml_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
(1, 1, 700, 'Joomla', '', 'joomla', 'file', '', 0, '3.3.4', '', 'http://update.joomla.org/core/sts/extension_sts.xml', '', ''),
...
(4, 3, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/nl-BE_details.xml', '', ''),
(5, 3, 0, 'Chinese Traditional', '', 'pkg_zh-TW', 'package', '', 0, '3.3.3.1', '', 'http://update.joomla.org/language/details3/zh-TW_details.xml', '', ''),
(6, 3, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/fr-FR_details.xml', '', ''),
(7, 3, 0, 'Galician', '', 'pkg_gl-ES', 'package', '', 0, '3.3.1.2', '', 'http://update.joomla.org/language/details3/gl-ES_details.xml', '', ''),
(8, 3, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/de-DE_details.xml', '', ''),
(9, 3, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/de-DE_details.xml', '', ''),
(10, 3, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '3.3.3.1', '', 'http://update.joomla.org/language/details3/el-GR_details.xml', '', ''),
(11, 3, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '3.3.5.1', '', 'http://update.joomla.org/language/details3/ja-JP_details.xml', '', ''),
...
(15, 3, 0, 'EnglishUS', '', 'pkg_en-US', 'package', '', 0, '3.3.1.1', '', 'http://update.joomla.org/language/details3/en-US_details.xml', '', ''),
(16, 3, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '3.3.3.1', '', 'http://update.joomla.org/language/details3/hu-HU_details.xml', '', ''),
(17, 3, 0, 'Afrikaans', '', 'pkg_af-ZA', 'package', '', 0, '3.2.0.2', '', 'http://update.joomla.org/language/details3/af-ZA_details.xml', '', ''),
(18, 3, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '3.3.5.1', '', 'http://update.joomla.org/language/details3/ar-AA_details.xml', '', ''),
(19, 3, 0, 'Belarusian', '', 'pkg_be-BY', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/be-BY_details.xml', '', ''),
(20, 3, 0, 'Bulgarian', '', 'pkg_bg-BG', 'package', '', 0, '3.3.0.1', '', 'http://update.joomla.org/language/details3/bg-BG_details.xml', '', ''),
(21, 3, 0, 'Bulgarian', '', 'pkg_bg-BG', 'package', '', 0, '3.3.0.1', '', 'http://update.joomla.org/language/details3/bg-BG_details.xml', '', ''),
(22, 3, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/ca-ES_details.xml', '', ''),
(23, 3, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '3.3.1.1', '', 'http://update.joomla.org/language/details3/zh-CN_details.xml', '', ''),
(24, 3, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '3.3.1.1', '', 'http://update.joomla.org/language/details3/zh-CN_details.xml', '', ''),
(25, 3, 0, 'Croatian', '', 'pkg_hr-HR', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/hr-HR_details.xml', '', ''),
(26, 3, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/cs-CZ_details.xml', '', ''),
(27, 3, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.3.5.1', '', 'http://update.joomla.org/language/details3/da-DK_details.xml', '', ''),
(28, 3, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/nl-NL_details.xml', '', ''),
(29, 3, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/et-EE_details.xml', '', ''),
(30, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.3.5.1', '', 'http://update.joomla.org/language/details3/it-IT_details.xml', '', ''),
(31, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/ko-KR_details.xml', '', ''),
(32, 3, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/lv-LV_details.xml', '', ''),
(33, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.3.5.1', '', 'http://update.joomla.org/language/details3/mk-MK_details.xml', '', ''),
(34, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.3.5.1', '', 'http://update.joomla.org/language/details3/mk-MK_details.xml', '', ''),
(35, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/nb-NO_details.xml', '', ''),
(36, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/fa-IR_details.xml', '', ''),
(37, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/pl-PL_details.xml', '', ''),
(38, 3, 0, 'Portuguese', '', 'pkg_pt-PT', 'package', '', 0, '3.3.3.1', '', 'http://update.joomla.org/language/details3/pt-PT_details.xml', '', ''),
(39, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.3.3.1', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', '', ''),
(40, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.3.5.1', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', '', ''),
(41, 3, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.3.3.3', '', 'http://update.joomla.org/language/details3/sv-SE_details.xml', '', ''),
(42, 3, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/sy-IQ_details.xml', '', ''),
(43, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.3.5.1', '', 'http://update.joomla.org/language/details3/ta-IN_details.xml', '', ''),
(44, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/th-TH_details.xml', '', ''),
(45, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.3.5.1', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', '', ''),
(46, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.3.5.1', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', '', ''),
(47, 3, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.3.3.15', '', 'http://update.joomla.org/language/details3/uk-UA_details.xml', '', ''),
(48, 3, 0, 'Uyghur', '', 'pkg_ug-CN', 'package', '', 0, '3.3.0.1', '', 'http://update.joomla.org/language/details3/ug-CN_details.xml', '', ''),
(49, 3, 0, 'Albanian', '', 'pkg_sq-AL', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/sq-AL_details.xml', '', ''),
(50, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(51, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
(52, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
(53, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.3.3.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(54, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.3.3.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(55, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
(56, 3, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/vi-VN_details.xml', '', ''),
(57, 3, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.3.0.2', '', 'http://update.joomla.org/language/details3/id-ID_details.xml', '', ''),
(58, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', '', ''),
(59, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.3.5.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
(60, 3, 0, 'Montenegrin', '', 'pkg_srp-ME', 'package', '', 0, '3.3.1.1', '', 'http://update.joomla.org/language/details3/srp-ME_details.xml', '', ''),
(61, 3, 0, 'EnglishCA', '', 'pkg_en-CA', 'package', '', 0, '3.3.3.1', '', 'http://update.joomla.org/language/details3/en-CA_details.xml', '', ''),
(62, 3, 0, 'FrenchCA', '', 'pkg_fr-CA', 'package', '', 0, '3.3.3.1', '', 'http://update.joomla.org/language/details3/fr-CA_details.xml', '', ''),
...
--
-- Table structure for table `tml_update_sites`
--

CREATE TABLE IF NOT EXISTS `tml_update_sites` (
...
--
-- Dumping data for table `tml_update_sites`
--

INSERT INTO `tml_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1412136738, ''),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1412136738, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1412136738, '');

-- --------------------------------------------------------

--
-- Table structure for table `tml_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `tml_update_sites_extensions` (
...
--
-- Dumping data for table `tml_update_sites_extensions`
--

INSERT INTO `tml_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `tml_usergroups`
--

CREATE TABLE IF NOT EXISTS `tml_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `tml_usergroups`
--

INSERT INTO `tml_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `tml_users`
--

CREATE TABLE IF NOT EXISTS `tml_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `tml_users`
--

INSERT INTO `tml_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`) VALUES
(8, 'Super User', 'admin', 'demo@demo.com', '$P$D5.EvX.bOy4eQ958sR7YmcJ0B6spr.1', 0, 1, '2014-08-27 07:16:12', '2014-10-01 11:39:33', '0', '', '0000-00-00 00:00:00', 0, '', '');

-- --------------------------------------------------------

--
-- Table structure for table `tml_user_keys`
--

CREATE TABLE IF NOT EXISTS `tml_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `tml_user_notes`
--

CREATE TABLE IF NOT EXISTS `tml_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `tml_user_profiles`
--

CREATE TABLE IF NOT EXISTS `tml_user_profiles` (
...
--
-- Table structure for table `tml_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `tml_user_usergroup_map` (
...
--
-- Dumping data for table `tml_user_usergroup_map`
--

INSERT INTO `tml_user_usergroup_map` (`user_id`, `group_id`) VALUES
(8, 8);

-- --------------------------------------------------------

--
-- Table structure for table `tml_viewlevels`
--

CREATE TABLE IF NOT EXISTS `tml_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `tml_viewlevels`
--

INSERT INTO `tml_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `tml_weblinks`
--

CREATE TABLE IF NOT EXISTS `tml_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
